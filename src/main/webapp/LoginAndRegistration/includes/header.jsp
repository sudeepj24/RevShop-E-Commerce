...
<header>
    ...
    LoginEntity user = (LoginEntity) (s != null ? s.getAttribute("user") : null);
    %>
  <div class="logo">
    ...
    <div class="nav-buttons">
        ...
        <a href="CartServlet?userId=<%=user != null ? user.getUserId() : "" %>">
        ...
        <div class="account-dropdown">
            ...
            <div class="dropdown-content" id="account-dropdown-content">
                ...
                %>
                <a href="LoginAndRegistration/user-login.jsp">Sign in</a>
                <a href="LoginAndRegistration/user-register.jsp">Register Account</a>
                <%
                }
                %>
            </div>
    ...
    <div class="category-strip">
        ...
        <a href="HomeServlet?category=HomeAppliances">Home Appliance</a>
